...
<%--                  <th>职位ID</th>--%>
              ...
              <tr>
                  <td>
                      <input type="checkbox" name="ids" value="${person.personId}">
                  </td>
                  <td>${person.personId}</td>
                  <td>${person.personName}</td>
                  <td>${person.phone}</td>
                  <td>
<%--                      <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/person/findById?personId=${person.personId}">修改</a>&nbsp;--%>
