...
public class StudentManagementSys {
    ...
    public static void main(String[] args) {
        ...
        List<Student> list = ListOps.load();
...
//          增加
                case "1":
                    ...
                    Student student_add = null;
                    try {
                        student_add = new Student(input_name, Integer.parseInt(input_id), Integer.parseInt(input_age));
                    } catch (StudentNumException | StudentAgeException e) {
                        e.printStackTrace();
                    }
...
//          修改
                case "3":
                    ...
                    Student student_change = null;
                    try {
                        student_change = new Student(name_new, Integer.parseInt(id_new), Integer.parseInt(age_new));
                    } catch (StudentNumException | StudentAgeException e) {
                        e.printStackTrace();
                    }
